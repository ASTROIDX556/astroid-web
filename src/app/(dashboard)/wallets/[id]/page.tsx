...
import { AssetDirectory } from '@/features/wallet/components/AssetDirectory';
        ...
        {(data) => {
          ...
          return (
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <SectionLabel>Asset Directory</SectionLabel>
                <AssetDirectory
                  walletId={data.id}
                  existingBalances={data.balances.map((b) => b.asset)}
                />
              </div>
            </div>
          );
