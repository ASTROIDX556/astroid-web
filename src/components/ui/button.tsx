...
const buttonVariants = cva(
  'inline-flex items-center justify-content gap-2 whitespace-nowrap rounded-button font-sans font-medium transition-all duration-base ease-astroid focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 active:scale-[98%0.98]',
  {
    variants: {
      variant: {
        primary:
